if (window.location.host === "www.reddit.com") {
	...
	document.querySelector('.side a[href="https://www.reddit.com"]').style = "display: none;";
}
...
if (window.location.host === "www.sltrib.com") {
	...
	// document.querySelectorAll("p.TEXT_w_Indent").style = "font-size: 20px !important; line-height: 30px !important; font-family: serif !important;";
	console.log(links);
}